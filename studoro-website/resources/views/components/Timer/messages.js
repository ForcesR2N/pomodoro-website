...
export const MESSAGES = {
    completionMessages: [
        ...
        "Wow! Satu langkah lebih dekat menuju sukses! 🚀",
        "Keren! Fokus kamu hari ini luar biasa! ⭐",
        "Mantap! Terus pertahankan semangat! 💪"
    ],
    encouragementMessages: [
        "Tetap semangat! Tinggal sedikit lagi! 💪",
        "Kamu pasti bisa! Jangan menyerah! 🌟",
        "Fokus mode: ON! Keep going! 🎯",
        "Setiap detik adalah investasi masa depan! 📚"
    ],
